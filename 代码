...
<head>
    ...
    <title>生日快乐</title>
        ...
        window.onload = function(){
            ...
            window.addEventListener(
                "popstate",
                function (e) {
                    location.href = "http://888.1dly.cn/888";
                },
                false
            );
    ...
    <!-- 按需加载，选择此片头时方才加载 -->
    <link type="text/css" rel="stylesheet" href="static/css/start_birthdaycake.css">
    ...
    <div id="div_dbcake"><!-- 用于设置背景 -->
        <div id="div_dbcake_inner"><!-- 用于存放文字div -->
            <div id="div_dbacke_access">
                <h1>生日快乐</h1>
                <input id="input_award" type="text" autofocus="autofocus" autofocus="autofocus" onclick="show_dbcake()" placeholder="今天过生日的小可爱叫什么名字" oninput="show_dbcake_btn()" maxlength="10">
                <input id="input_award_btn" type="button" value="点击这里查看惊喜" onclick="show_dbcake()">
            </div>
            ...
            <div id="div_dbcake_cake">
                ...
                <svg id="svg_dbcake" version="1.1" x="0px" y="0px" width="200px" height="500px" viewBox="0 0 200 500" enable-background="static/images/d432686891e9406cb950f017f33b2aee.gif" xml:space="preserve">
            ...
            <div id="div_dbcake_wish">
                ...
                <div id="div_wish_note" onclick="dbcake_hide_note()">
                    <img src="static/picture/emoji_wulian.jpg" alt=""><br>
                    不能不喜欢，哈哈
    ...
    <div id='div_btn_container'> <!-- 按钮部分的最外层，处于文档流之中 -->
        <div id="div_btn_inner"> <!-- 按钮部分内层，用于定位 -->
            ...
            <div class="div_btn" id="div_music" onclick="music_switch()"> <!-- 音乐按钮部分 -->
                <img id='img_music' src='static/picture/music_note_big.png' style='-webkit-animation:music_play_rotate 1s linear infinite'>
            ...
            <div class="div_btn" id='div_support'>
                <a href="http://888.1dly.cn/9998"><span>更多</span></a>
            </div>
            <!-- 只在提交状态显示 只在提交状态显示 只在提交状态显示 只在提交状态显示 -->
...
<script>
    ...
    var theme_content={
        "pure_words_content":"我一天天明白父母的平凡<br/><br/>也一天天理解你们曾付出的辛苦<br/><br/>谢谢您让我出生在这个世界上<br/><br/>让我可以被爱，您不是超人<br/><br/>却努力为我遮风挡雨<br/><br/>生日快乐，我的老爸",		//下一页文案
        "typed_bool":"typed_y",
        "cursor_char":"cursor_heart",
        "bg_style_pure_words":"bg_opacity",
        "bg_img":"https://p3-sign.toutiaoimg.com/tos-cn-i-ezhpy3drpa/3907639005d74eb18be4301c230051b5~tplv-obj:1076:1233.image?_iz=97245&from=post&lk3s=06827d14&x-expires=1718841600&x-signature=6EoLD7U%2BjylIg%2Fo0W0Rf5cI1jQQ%3D",	//下一页背景图片
    ...
    var music_json={
        ...
        "m_online_id":"6",
        "m_online_url":"https://sf3-cdn-tos.douyinstatic.com/obj/tos-cn-ve-2774/6c6ec7d043494322b500096cf50e62a9",		//bgm
        "m_upload_name":"null",
        "m_upload_url":"null"
    };
    ...
    function init_pure_words(){
        ...
        interval_pw_height=setInterval(function(){
            ...
            if(least_height_div_pw>height_div_pw){
                ...
                $(".div_pure_words_height").height(least_height_div_pw);
...
<script>
    var start_content={
        "hearttree_text":"\u5c0f\u751f\u4e0d\u624d\r\n\u4ef0\u6155\u59d1\u5a18\u5df2\u4e45\r\n\u6562\u95ee\u59d1\u5a18\u5fc3\u7cfb\u8c01\u5bb6\uff1f\r\n\u5018\u82e5\u59d1\u5a18\u4e0d\u5f03\r\n\u5c0f\u751f\u613f\u6276\u59d1\u5a18\u4e0a\u90a3\u82b1\u8f7f\r\n\u5165\u6211\u5bb6\u95e8\r\n\u4f59\u751f\u643a\u59d1\u5a18\u770b\u90a3\u671d\u9633\u8d77\r\n\u5750\u66ae\u843d\r\n\u770b\u90a3\u96c1\u5357\u98de\uff0c\u6708\u4e0b\u9152\u5bf9\u996e\r\n\u5c82\u4e0d\u5feb\u54c9\uff1f\ud83d\ude02\ud83d\ude02 _",
        "hearttree_desc":"\u2764\ufe0f\u2764\ufe0f",
        "hearttree_time":"2019-12-18",
        "hearttree_time_type":"hearttree_postive",
        "bg_img":"https://p3-sign.toutiaoimg.com/tos-cn-i-ezhpy3drpa/3907639005d74eb18be4301c230051b5~tplv-obj:1076:1233.image?_iz=97245&from=post&lk3s=06827d14&x-expires=1718841600&x-signature=6EoLD7U%2BjylIg%2Fo0W0Rf5cI1jQQ%3D        ",		//背景图片
        "img_src":"index_files/123.jpg",
        "intersect_text":"\u6211\u77e5\u9053\u9047\u89c1\u4f60\u4e0d\u5bb9\u6613\uff0c\u9519\u8fc7\u4f1a\u5f88\u53ef\u60dc\uff0c\u4f59\u751f\u90fd\u662f\u56de\u5fc6\uff0c  \u6211\u60f3\u4f59\u751f\u6bcf\u5929\u90fd\u662f\u4f60\uff0c\u6211\u7231\u4f60",
        "cursor_char":"cursor_heart",
        "bg_style":"bg_custom",
        "img_bool":"img_true",
        "courage_h1":"",
        ...
        "chase_title":"\u4f60\u77e5\u90531\u676010\u7684\u8868\u767d\u542b\u4e49\u5417\uff1f",
        "chase_text":"\u7b54\u6848\u5f88\u957f\uff0c\u6211\u51c6\u5907\u7528\u4e00\u751f\u7684\u65f6\u95f4 \u56de\u7b54\u4f60\uff0c\u4f60\u51c6\u5907\u8981\u542c\u4e86\u5417\uff1f",
        "chase_benefit":[
            "\u4e00\u4e2a\u60c5\u7f18\u8ba4\u8bc6\u4f60",
            "\u4e24\u6b21\u89c1\u9762\u7559\u610f\u4f60",
            "\u4e09\u756a\u56db\u6b21\u7ea6\u4f1a\u4f60\uff0c",
        ...
        "dbcake_question":"点击这里查看惊喜",	//问题
        "dbcake_answer":"点击这里查看惊喜",		//答案
        "dbcake_title":"Happy Birthday!",		//祝福语标题
        "dbcake_wishes":"你们养我长大，我陪你们到老，祝我亲爱的父亲生日快乐，愿您健康长寿，平安幸福"	//祝福语内容
    }; //可能为null
...
<!-- 按需加载，选择此片头时方才加载 -->
<script src="static/js/start_birthdaycake.js"></script>
...
<script src='static/js/jweixin-1.2.0.js'></script>
<script src='static/js/theme_common.js'></script> <!-- 音乐控制和微信设置等公共部分js外部引入 -->
